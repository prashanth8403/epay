...
namespace Rook_Atlas.web.dashboard.access
{
    public partial class transaction1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string ReferenceCheck = "select count(*) from transaction where UserUsn='" + USN + "';";
            ...
            if (check >= 1)
            {
                string Query = "select ReferenceNo,TransID,Particulars,Amount,Status,Date from transaction where UserUsn='" + USN + "';";
