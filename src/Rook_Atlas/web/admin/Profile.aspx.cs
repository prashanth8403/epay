    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           /* if (Session["OscarDeltaMikerKilo"] == null)
            ...
            string ReferenceCheck = "select count(*) from userprofile;";
            ...
            if (check >= 1)
            {
                string Query = "select StudentName,FatherName,PhoneNo,Email,BirthDate,UserUsn from userprofile;";
                ...
                if (rd.HasRows)
                {
                    while (rd.Read())
                    {
                        ...
                        Transcationtable.Append("<td>" + rd[5] + "</td>");
                        ...
                        Transcationtable.Append("<td>" + ((DateTime)rd[4]).ToString("dd-MMMM-yyyy") + "</td>");
